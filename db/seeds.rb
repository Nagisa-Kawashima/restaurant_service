...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  User.create!(
    [
      ...
      { email: "test@test8.com",
        name: "Amani",
        password: "password",
        profile_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-user8.jpg"),
        filename: "sample-user8.jpg"),
        country_code: "ID",
        introduction: "好きな料理はイカンバカールです。スパイスを多めにかけて食べるのが好きです。よろしくお願いします！"}
    ]
  )
  ...
  PostComment.create!(
    [
      ...
      { user_id: 1,
        post_id: 7,
        comment: "よかったら私と友達になって欲しいです！色々お話させてください！",
      }
    ]
  )
